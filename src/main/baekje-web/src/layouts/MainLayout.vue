          ...
          <div class="user-name">
            ...
            >
              ...
              <q-input
                filled
                name="buyertel"
                model-value="10-1234-5678"
                style="display: none"
              />
              <q-input
                filled
                name="buyeremail"
                model-value="test@inicis.com"
                style="display: none"
              />
              <q-input
                filled
...
export default defineComponent({
  ...
  setup() {
    ...
    //iframe 닫기 event
    // function inicisCloseEvent() {}

    // 2. async를 걸어준다.
    // onBeforeMount(async () => {
    //   // 3. router.isReady의 응답을 기다린다.
    ...
    onUnmounted(() => {
      ...
      //   connected = false;
      // });
      console.log("unmounted polling===>", polling);
    ...
    return {
      ...
      fnGoInicis() {
        //여기에서 파라미터 같이 넘기기 -> 단순 페이지 이동으로 변경
        router.push({
          path: "/inicisTest",
          // query: {
          //   goodname: "테스트상품",
