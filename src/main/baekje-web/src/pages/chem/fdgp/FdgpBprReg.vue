      ...
      if (!util.isEmpty(e.data.datasetData)) {
        ...
        try {
          ...
          await api.post("/bindInsert/fdgp.bpr/insertFdgpBpr", {
            ...
            eData1: e.data.datasetData.dataset_1[0],
            eData2: e.data.datasetData.dataset_2[0],
            eData3: e.data.datasetData.dataset_3[0],
            eData4: e.data.datasetData.dataset_4[0],
            eData5: e.data.datasetData.dataset_5[0],
            eData6: e.data.datasetData.dataset_6[0],
