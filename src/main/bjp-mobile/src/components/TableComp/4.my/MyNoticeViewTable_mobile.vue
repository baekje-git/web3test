...
import MyNoticeComp_mobile from 'src/components/DialogComp/4.myDialogComp/MyNoticeComp_mobile.vue';
...
const rows = ref([
  {
    new: true,
    badge: '필독',
    제목: '타사이트를 통한 주문 관련 공지사항',
    날짜: '2022.04.21',
  },
  {
    new: false,
    badge: '필독',
    제목: '타사이트를 통한 주문 관련 공지사항 2',
    날짜: '2022.04.21',
  },
  {
    new: false,
    badge: '필독',
    제목: '타사이트를 통한 주문 관련 공지사항 3',
    날짜: '2022.04.21',
  },
]);
