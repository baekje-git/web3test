            ...
            <template v-slot:header="props">
              <div class="second_table_header_wrap">
                ...
                <div class="table_header_item">
                  ...
                  <span class="red-text">{{ props.cols[4].label }}</span>
                </div>
                <div class="table_header_item">
                  <span>{{ props.cols[5].label }}</span> <br/>
                  <span>{{ props.cols[6].label }}</span>
                </div>
              </div>
            </template>
            ...
            <template v-slot:body="props">
              <q-tr>
                <div class="second_table_wrap">
                  ...
                  <div class="table_item">
                    <q-td>{{ props.row.매출목표 }}</q-td>
                    <q-td>{{ props.row.매출 }}</q-td>
                  </div>
                  <div class="table_item">
                    <q-td>{{ props.row.매출퍼센트 }}</q-td>
                    <q-td>{{ props.row.이익률 }}</q-td>
                  </div>
                  <div class="table_item">
                    <q-td>{{ props.row.판매 }}</q-td>
                    <q-td>{{ props.row.반품 }}</q-td>
...
import DatePickerMonthComp_mobile from 'src/components/__commonComp/datepickerComp/DatePickerMonthComp_mobile.vue';
...
const columns2 = [
  { name: 'name', label: '부서명', align: 'center' },
  { name: '매출목표', label: '매출목표', align: 'center' },
  { name: '매출', label: '매출', align: 'center' },
  { name: '매출%', label: '매출%',align: 'center' },
  { name: '이익률', label: '이익률',align: 'center' },
  { name: '판매', label: '판매', align: 'center' },
  { name: '반품', label: '반품', align: 'center' },
]
