    ...
    <q-page-container class="first-container">
      <q-banner dense :class="$q.dark.isActive ? '' : ''" class="search-wrap">
        <div class="q-gutter-md row items-start">
          ...
          <dev>
            <span>시험지시자</span>
            <q-input filled v-model="writerNm" label="시험지시자" />
          </dev>
          <dev>
            <span>문의등록여부</span>
            <CmmnCode
...
const columns = [
  ...
  { name: "WRITER_NM", label: "시험지시자", field: "WRITER_NM" },
  { name: "WRITER_DT", label: "시험지시자 확인일", field: "WRITER_DT" },
