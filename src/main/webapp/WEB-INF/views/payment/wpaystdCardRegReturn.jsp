...
<body bgcolor="#FFFFFF" text="#ffffff" leftmargin=0 topmargin=15 marginwidth=0 marginheight=0 bottommargin=0 rightmargin=0 style="display:none;">
<form id="SendPayAuthForm" name="SendPayAuthForm" method="POST" >
	<div style="background-color:#ffffff;width:100%;font-size:13px;color: #ffffff;background-color: #ffffff;text-align: center">
...
<!--
    ...
    function gopage() {
        ...
        if ("${param_resultCode}" == "0000" || "${param_resultCode}" == "7028" || "${param_resultCode}" == "9001") {
            goSkip();
        } else {
    ...
    function goSkip()
    {
        var sendfrm = document.getElementById("SendPayAuthForm");
        sendfrm.action = "/payment/wpaystdPayAuthCardRequest";
        sendfrm.submit();
    }
