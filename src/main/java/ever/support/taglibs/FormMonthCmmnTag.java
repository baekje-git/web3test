...
public class FormMonthCmmnTag extends TagSupport {
	private static final long serialVersionUID = -2213856975429353250L;
	...
	public int doStartTag() throws JspException {
		String serverMonth = DateUtil.getDate("yyyy-MM");
		StringBuffer date = new StringBuffer();
		try {
			date.append("<span class=\"board_data_wrap month\">");
			...
			if (this.pBtnCnt > 0) {
				if (this.pBtnCnt >= 1) {
					...
					mapAttr.put("onclick",
							"DateUtil.getMonthContrl('" + this.pNm + "','m','1','','" + this.pNm + "_BTCLR_M1');");
				...
				if (this.pBtnCnt >= 2) {
					...
					mapAttr.put("onclick",
							"DateUtil.getMonthContrl('" + this.pNm + "','m','3','','" + this.pNm + "_BTCLR_M3');");
				...
				if (this.pBtnCnt >= 3) {
					...
					mapAttr.put("onclick",
							"DateUtil.getMonthContrl('" + this.pNm + "','m','6','', '" + this.pNm + "_BTCLR_M6');");
				...
				if (this.pBtnCnt >= 4) {
					...
					mapAttr.put("onclick",
							"DateUtil.getMonthContrl('" + this.pNm + "','m','12','','" + this.pNm + "_BTCLR_Y1');");
				...
				if (this.pBtnCnt >= 5) {
					...
					mapAttr.put("onclick",
							"DateUtil.getMonthContrl('" + this.pNm + "','m','24','','" + this.pNm + "_BTCLR_Y2');");
				...
				if (this.pBtnCnt >= 6) {
					...
					mapAttr.put("onclick",
							"DateUtil.getMonthContrl('" + this.pNm + "','m','36','','" + this.pNm + "_BTCLR_Y3');");
