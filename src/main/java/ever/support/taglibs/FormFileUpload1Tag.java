...
public class FormFileUpload1Tag extends TagSupport {
	private static final long serialVersionUID = 1796149275422807916L;
	...
	public String getpHeaderTitle() {
		return this.pHeaderTitle;
	}

	public void setpHeaderTitle(String pHeaderTitle) {
		this.pHeaderTitle = pHeaderTitle;
	}
	...
	public int doStartTag() throws JspException {
		...
		try {
			...
			fileBox.append("</script>                                                                            ")
					.append("\r\n");
			fileBox.append("<div class=\"title_area\">");
			fileBox.append("    <div class=\"main_title\">")
					.append((String) StringUtils.defaultIfEmpty(this.pHeaderTitle, "제목을입력하세요.")).append("</div>");
			fileBox.append("    <div class=\"filebox\" style=\"position:relative;top:6px;float:right;\">");
