...
public class CmmnServiceImpl implements CmmnService {
	...
	@Override
	public String getNextSn(String dealType, String custBrch, String dealDt, String option) throws Exception {
		HashMap<String, Object> nextMap = new HashMap<String, Object>();

        nextMap.put("I_DEAL_TYPE" , dealType);
        nextMap.put("I_CUST_BRCH" , custBrch);    // 9999999
        nextMap.put("I_DEAL_DT"   , dealDt);
        nextMap.put("I_OPTION"    , option);

        cmmnDao.callProcedure("cmmn.getNextSn", nextMap);
        String nextSn = nextMap.get("O_VAL").toString();
