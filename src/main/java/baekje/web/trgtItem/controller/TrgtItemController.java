package baekje.web.trgtItem.controller;
...
@RequestMapping("/trgtItem")
@RestController
public class TrgtItemController {
	@Autowired
	...
	public ResponseEntity<Object> selectNtfctInfoList(@RequestParam HashMap<String, Object> hMap) throws Exception {
		...
		List<Object> list = this.cmmnService.selectList("trgtItem.selectTrgtItemList", hMap);
