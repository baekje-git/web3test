    ...
    >
                  ...
                  <div class="DatePickerComp_b_wrap">
                    ...
                    <div class="date_btn_wrap">
                      <q-btn class="calendar_icon" unelevated dense>
                        <img
                          src="/src/assets/icons/calendar-days-solid.svg"
                          alt="calendar"
                        />
                        <q-popup-proxy
      ...
      <template v-slot:header="props">
        <q-tr :props="props" class="table_header">
          <q-th key="CHG_DT" :props="props">
            {{ props.cols[0].label }}
          </q-th>
          <!-- <q-th style="width: 35%; padding: 0"> -->
          <!-- <p class="table_header_sub_top">
              <q-th> 품목정보 </q-th>
            </p> -->
          <!-- <p class="table_header_sub_bottom"></p> -->
          ...
          <!-- </q-th> -->
          <q-th key="WP2_DIFF" :props="props">
            {{ props.cols[4].label }}
          </q-th>
          <q-th key="WP2_CHG_PCT" :props="props">
            {{ props.cols[5].label }}
          </q-th>
          <q-th class="td-multi">
            <p class="table_header_sub_top">
      ...
      <template v-slot:body="props">
        <q-tr :props="props">
          <q-td key="CHG_DT" :props="props" @click="onClickRow(props.row)">
            <div>
              {{
                moment(props.row.CHG_DT, "YYYY-MM-DD HH:mm:ss").format(
                  "YYYY-MM-DD"
                )
              }}
            </div>
          ...
          >
            <div class="q-table_item">
              <div class="q-table_badge_wrap">
                ...
                <q-badge
                  class="bdg-line"
                  :class="props.row.PAY_ITEM_NM === '비급여' ? 'nonpay' : 'pay'"
                >
                  {{
          ...
          <q-td
            ...
            @click="onClickRow(props.row)"
          >
            <div>{{ util.getNumberFormat(props.row.WP2_DIFF) }}</div>
          </q-td>
          <q-td
            key="WP2_CHG_PCT"
            :props="props"
...
async function fetchItemList() {
  ...
  const res = await api.get("/ntfctInfo/searchItem", {
...
function exportTable() {
  ...
  api
    ...
    .then(function (res) {
      ...
      link.setAttribute(
        "download",
        "고시정보_" + moment().format("YYYYMMDD") + ".xls"
      );
