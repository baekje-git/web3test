    ...
    <div class="orderTable_4a">
      <div class="prd_wrap prdinfo">
        ...
        <div class="box_for_position">
          <div class="prd_img_r">
            <img src="/handok.png" alt="PRODUCT IMG" />
          </div>
          <div class="prd_detail">
            <q-markup-table separator="none" flat dense>
              ...
              <tbody class="orderTable_4a_tbody">
                <tr>
                  <td class="text-left">규격</td>
                  <td class="text-left">
                    {{ itemDetailInfo.UNIT ?? "-" }}
                  </td>
                  <td class="text-left">박스입수</td>
                  <td class="text-left">
                    <span>(소)</span>
                    {{
                ...
                <tr>
                  ...
                  <td class="text-left">
                    {{
                      ...
                      itemDetailInfo.MAX_ORD_QTY === 9999
                        ? ""
                ...
                <tr>
                  ...
                  <td
                    class="text-left"
                    style="font-weight: bold; color: #384dd6"
                  >
                    <p
...
bus.on("init", () => {
  ...
  itemDetailInfo.value.FILE_PATH = undefined;
  itemDetailInfo.value.ORG_FILE_NM = undefined;
});
</script>
