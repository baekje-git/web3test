  ...
  <div class=" ">
    ...
    >
          ...
          >
            <div class="q-table_header_title flex_center">
              ...
              <div class="q-table_header_accumulate">
                <p>
                  누적 출하 수량 : 매출
                  <b>{{ accShpmntQtyData.SALE_CNT }}</b> / 반품
                  <b>{{ accShpmntQtyData.BACK_CNT }}</b>
                </p>
              </div>
            </div>
      ...
      <template v-slot:body-cell-ORD_DT="props">
        <q-td :props="props" style="cursor: pointer" class="ordertb3-t2">
          {{ moment(props.value).format("YYYY-MM-DD") }}
        </q-td>
      </template>

      <template v-slot:body-cell-WP2_AMT="props">
        <q-td :props="props" style="text-align: right" class="ordertb3-t3">
          {{ props.value }}
        </q-td>
      </template>

      <template v-slot:body-cell-ITEM_QTY="props">
        <q-td :props="props" style="cursor: pointer" class="ordertb3-t4">
          {{ props.value }}
        </q-td>
      </template>

      <template v-slot:body-cell-SERIAL_NO="props">
        <q-td :props="props" style="cursor: pointer" class="ordertb3-t5">
          {{ props.value }}
        </q-td>
      </template>

      <template v-slot:body-cell-EXP_DT="props">
        <q-td :props="props" style="cursor: pointer" class="ordertb3-t6">
          {{
