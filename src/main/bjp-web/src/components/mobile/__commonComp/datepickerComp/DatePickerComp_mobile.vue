<template>
  <div class="flex_between" style="gap: 8px; width: 126px">
...
function validDate(val) {
  if (val) {
    const isValid1 = moment(val, "YYYY.MM.DD", true).isValid();
    const isValid2 = moment(val, "YYYYMMDD", true).isValid();
    const isValid3 = moment(val, "YYYY/MM/DD", true).isValid();
    const isValid4 = moment(val, "YYYY-MM-DD", true).isValid();
