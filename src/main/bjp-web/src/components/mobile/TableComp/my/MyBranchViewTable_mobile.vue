<template>
  <div>
    ...
    >
      ...
      >
        <div class="">
          <MyBranchComp_mobile :rowSno="rowChk" />
        </div>
      </DialogLayout_mobile>
...
import MyBranchComp_mobile from "src/components/mobile/DialogComp/4.myDialogComp/MyBranchComp_mobile.vue";
