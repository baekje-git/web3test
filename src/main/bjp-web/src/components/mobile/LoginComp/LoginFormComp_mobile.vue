<template>
  <div class="form_wrap_mobile">
    ...
    <div class="id_wrap_mobile">
      <label class="input_label_mobile">User ID </label>
      <q-input
        class="input_mobile"
    ...
    <div class="pass_wrap">
      <label class="input_label_mobile">Password </label>
      <q-input
        class="input_mobile"
    ...
    <div class="link_wrap">
      ...
      <div class="find_wrap" v-if="!isCompanyLogin">
        <a flat outline class="link_txt" @click="dialog_id = true"
          >아이디 찾기</a
        >
      </div>
    </div>
    ...
    <div class="button_wrap">
      ...
      <div class="etcBtn_wrap_mobile">
        <a
          ...
          >신규 거래문의</a
        >
        <a target="_blank" class="link_txt" @click="onClickRedirect('baekje')">
          백제약품 바로가기
        </a>
      </div>
    </div>
      ...
      <div class="etc_dialog_wrap">
        ...
        <div class="etc_result">
          ...
          <BtnComp_mobile
            buttonText="취소"
            btnSize="md"
            class="btn-line default btn-full"
            style="width: 100%"
            v-close-popup
          />
        </div>
